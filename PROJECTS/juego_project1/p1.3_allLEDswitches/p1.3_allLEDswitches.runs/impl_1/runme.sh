...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project1/p1.3_allLEDswitches/p1.3_allLEDswitches.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log allLedswitches.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source allLedswitches.tcl -notrace
