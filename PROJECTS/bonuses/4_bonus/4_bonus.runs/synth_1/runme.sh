...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/bonuses/4_bonus/4_bonus.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MinMuxTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MinMuxTop.tcl
