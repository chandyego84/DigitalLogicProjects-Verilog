...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project9/project_9.2/project_9.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log addrSubtrctr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source addrSubtrctr.tcl -notrace
