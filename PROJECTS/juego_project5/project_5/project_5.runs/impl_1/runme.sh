...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project5/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_demux_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_demux_wrapper.tcl -notrace
