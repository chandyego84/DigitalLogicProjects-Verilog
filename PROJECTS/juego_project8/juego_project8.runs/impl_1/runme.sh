...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project8/juego_project8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCDctr_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCDctr_4.tcl -notrace
