...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project1/p1.c2_masterONoff/p1.c2_masterONoff.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log masterONoff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source masterONoff.tcl
