...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project9/project_9.2/project_9.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log addrSubtrctr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source addrSubtrctr.tcl
