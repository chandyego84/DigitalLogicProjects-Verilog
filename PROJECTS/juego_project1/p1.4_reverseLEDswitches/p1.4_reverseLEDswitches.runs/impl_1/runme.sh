...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project1/p1.4_reverseLEDswitches/p1.4_reverseLEDswitches.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reverseLEDsw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reverseLEDsw.tcl -notrace
