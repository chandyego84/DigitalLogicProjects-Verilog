...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project1/p1.4_reverseLEDswitches/p1.4_reverseLEDswitches.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reverseLEDsw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reverseLEDsw.tcl
