...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project7/juego_project7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log piso_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source piso_16.tcl
