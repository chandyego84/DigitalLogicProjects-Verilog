...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project2/juego_project2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log automobile.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source automobile.tcl
