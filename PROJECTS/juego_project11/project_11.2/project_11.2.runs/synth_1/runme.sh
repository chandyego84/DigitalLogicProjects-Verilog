...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project11/project_11.2/project_11.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log watchTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source watchTop.tcl
