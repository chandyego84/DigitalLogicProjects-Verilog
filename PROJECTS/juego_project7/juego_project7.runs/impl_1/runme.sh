...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project7/juego_project7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log piso_16.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source piso_16.tcl -notrace
