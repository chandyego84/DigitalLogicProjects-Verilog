...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project12/project_12.2/project_12.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RTMtop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RTMtop.tcl -notrace
