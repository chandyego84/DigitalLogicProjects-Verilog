...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/bonuses/4_bonus/4_bonus.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MinMuxTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MinMuxTop.tcl -notrace
