...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project4/project4_CombinationalBuildingBlocks/juego_project4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shifter_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shifter_8.tcl
