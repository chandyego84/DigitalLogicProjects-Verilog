...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project11/project_11.2/project_11.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log watchTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source watchTop.tcl -notrace
