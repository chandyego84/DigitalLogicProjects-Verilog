...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/bonuses/5_bonus/5_bonus.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log twoDigSevSegTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source twoDigSevSegTop.tcl
