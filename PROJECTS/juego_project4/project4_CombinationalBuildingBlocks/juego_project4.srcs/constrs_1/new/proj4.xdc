...
#set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { sel[2] }]; #IO_L24P_T3_34 Schematic=BTN2
#set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { sel[3] }]; #IO_L23P_T3_35 Schematic=BTN3
