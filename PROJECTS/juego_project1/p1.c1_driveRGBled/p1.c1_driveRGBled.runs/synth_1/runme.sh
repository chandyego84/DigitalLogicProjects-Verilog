...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project1/p1.c1_driveRGBled/p1.c1_driveRGBled.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log driveRGBled.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source driveRGBled.tcl
