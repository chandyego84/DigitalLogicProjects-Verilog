...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project10/project_10/project_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALUtop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALUtop.tcl
