...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project1/p1.3_allLEDswitches/p1.3_allLEDswitches.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log allLedswitches.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source allLedswitches.tcl
