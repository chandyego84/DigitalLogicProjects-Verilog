...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project2/juego_project2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log automobile.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source automobile.tcl -notrace
