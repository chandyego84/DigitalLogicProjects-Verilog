...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project10/project_10/project_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALUtop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALUtop.tcl -notrace
