...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/juego_project12/project_12.2/project_12.2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RTMtop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RTMtop.tcl
