...
HD_PWD='C:/Users/chand/Desktop/EE214/PROJECTS/bonuses/5_bonus/5_bonus.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log twoDigSevSegTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source twoDigSevSegTop.tcl -notrace
